...
<div id="wrapper">
    <div id="container">
        <div class="open-book">
            <article>
                <h2 class="chapter-title">Tentang Selopuro</h2>
                <p>
                    Pada zaman nenek moyang, Tanah Jawa masih berupa hutan belantara dengan hanya sedikit perkampungan. Pada tahun 1745 Masehi, di Lasem sudah berdiri sebuah Kerajaan yang dipimpin oleh Ratu Dewi Indu. Sementara itu, Suroadimenggolo III, seorang bangsawan dari Semarang, menjadi Bupati Lasem. Ia berkedudukan di dukuh Tulis, yang juga dikenal sebagai "Loji" dan berfungsi sebagai kantor Bupati Lasem. Suroadimenggolo III mendirikan tangsi militer di puncak bukit Gebang.
                </p>
                <p>
                    Sebelum terbentuknya Desa Selopuro, wilayah tersebut terbagi menjadi empat pedukuhan, yaitu: Dukuh Gapuro, Dukuh Topar, Dukuh Klindon, dan Dukuh Tulis. Menurut cerita para sesepuh desa terdahulu, pedukuhan yang paling tua adalah Dukuh Gapuro, yang sekarang disebut Dukuh Gepuro. Pedukuhan berikutnya adalah Dukuh Topar, kemudian Dukuh Klindon, dan yang terakhir adalah Dukuh Tulis.
                </p>
                <p>
                    Dukuh Gepuro disebut dukuh tertua,karena Dukuh Gepuro sebagai pintu masuk kewilayah selopuro.
                </p>
                <ul>
                    <li><mark class="pink">Dukuh Gepuro</mark> pada zaman itu pernah menjadi pusat Penerintahan Desa atau Petinggen yang dipimpin seorang Petinggi yang bernama Sumo Lasi. </li>
                ...
                <dl>
                    ...
                    <dd>
                        <em>Dilansir dari</em><br>
                        RPJM Desa Selopuro Tahun 2020 - 2025.
                    </dd>
                </dl>
            </article>
            <footer>
...
#st.write("Ini adalah gambaran umum desa")
